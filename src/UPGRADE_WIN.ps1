...
$LogFile = Join-Path $LogDir "UPGRADE_WIN.txt"

if (-not (Test-Path $LogFile)) {
    "Log file created by UPGRADE_WIN.ps1." | Out-File $LogFile -Append
}

# ==================== Script Execution ====================
Log "Starting UPGRADE_WIN.ps1 script..." "INFO"
...
Log "==== UPGRADE_WIN Script Completed ===="